...
const iconeFechado = document.getElementById("olho-fechado");
const iconeAberto = document.getElementById("olho-aberto");
const inputDeCPF = document.getElementById("input-CPF");
const campoDeSenha = document.getElementById("input-password");
